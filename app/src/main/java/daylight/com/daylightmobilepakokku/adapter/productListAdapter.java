...
public class productListAdapter extends RecyclerView.Adapter<productListAdapter.PnViewHolder> {
    ArrayList<NewProdcutModel>myary=new ArrayList<>();
    LayoutInflater layoutInflater;
    Context context;
    public productListAdapter(Context c, ArrayList<NewProdcutModel> arylist){
        context=c;
        myary=arylist;
    }
    ...
    public void onBindViewHolder(@NonNull final PnViewHolder holder, int position) {
        ...
        holder.whole.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                        ...
                        PdetailView detail=new PdetailView();
