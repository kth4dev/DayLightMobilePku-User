...
public class SecondPhoneNameAdapter extends RecyclerView.Adapter<SecondPhoneNameAdapter.PnViewHolder> {
    ArrayList<Categories>myary=new ArrayList<>();
    LayoutInflater layoutInflater;
    Context context;
    public SecondPhoneNameAdapter(Context c, ArrayList<Categories> arylist){
        context=c;
        myary=arylist;
    }
    ...
    public void onBindViewHolder(@NonNull final PnViewHolder holder, int position) {
        ...
        holder.imgone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SecondProduct_List detail=new SecondProduct_List();
                Bundle bundle = new Bundle();
                bundle.putSerializable("ProductTitle","second"+k.getCname());
