...
public class BrandPhoneNameAdapter extends RecyclerView.Adapter<BrandPhoneNameAdapter.PnViewHolder> {
    ArrayList<Categories>myary=new ArrayList<>();
    LayoutInflater layoutInflater;
    Context context;
    public BrandPhoneNameAdapter(Context c, ArrayList<Categories> arylist){
        context=c;
        myary=arylist;
    }
    ...
    public void onBindViewHolder(@NonNull final PnViewHolder holder, int position) {
        ...
        holder.imgone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Product_List detail=new Product_List();
