 ...
 * {@link Accessory_List.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Accessory_List#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Accessory_List extends DialogFragment {
    ...
    public static Accessory_List newInstance(String param1, String param2) {
        Accessory_List fragment = new Accessory_List();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ArrayList<NewProdcutModel> str=new ArrayList<>();
        final AccessoryListAdapter adapter=new AccessoryListAdapter(getContext(),str);
        myrv.setAdapter(adapter);
        myrv.setLayoutManager(new GridLayoutManager(getContext(),2));
        ChildEventListener childEventListener=new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                NewProdcutModel user=dataSnapshot.getValue(NewProdcutModel.class);
                str.add(0,user);
